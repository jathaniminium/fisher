...
params = ['ombh2','omch2','scalar_spectral_index','scalar_amp',
          'r']#'massive_neutrinos']#'helium_fraction']#]#]#]#]
...
window_dir = 'windows_sptpol_2015_testTEEE150_lmin50_lmax3000/'
cov_file = 'sptpol_2015_testTEEE150_lmin50_lmax3000.cov_file'
#nbins=50
nbins=59
delta_ell = 50
raw=False
