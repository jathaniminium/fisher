...
d2 = pk.load(open(bandpower_dir+'spectra_realizations_100_skyCoverage535.0_Tdepth6.0_Pdepth8.5.pkl', 'r'))
...
pt.plot_TT(avg_bandcenterT2013, avg_bandpowerT2013, avg_banderrorT2013, tell=tell, tTT=tTT, label='2015 Knox proj', color='r', plot_theory=False, ylog=True, xlog=False, xlim=[2,9000])
pt.plot_TT(avg_bandcenterT2015proj, avg_bandpowerT2015proj, avg_banderrorT2015proj, tell=tell, tTT=tTT, label='2015 Prop', color='k', plot_theory=False, ylog=True, xlog=False, xlim=[2,9000])
...
pt.plot_EE(avg_bandcenterE2013, avg_bandpowerE2013, avg_banderrorE2013, tell=tell, tEE=tEE, label='2015 Knox', color='r', plot_theory=False, ylog=True, xlog=False, xlim=[2,9000])
pt.plot_EE(avg_bandcenterE2015proj, avg_bandpowerE2015proj, avg_banderrorE2015proj, tell=tell, tEE=tEE, label='2015 Prop', color='k', plot_theory=False, ylog=True, xlog=False, xlim=[2,9000])
...
pt.plot_BB(avg_bandcenterB2013, avg_bandpowerB2013, avg_banderrorB2013, tell=tell, tBB=tBB, label='2015 Knox', color='r', plot_theory=False, ylog=True, xlog=False, xlim=[2,9000])
pt.plot_BB(avg_bandcenterB2015proj, avg_bandpowerB2015proj, avg_banderrorB2015proj, tell=tell, tBB=tBB, label='2015 Prop', color='k', plot_theory=False, ylog=True, xlog=False, xlim=[2,9000])


#Get the cov of two spectra.
cov_TT, rho_TT = ut.get_cov_matrix(d['Tpower'], avg_bandpowerT2012, return_rho=True)
